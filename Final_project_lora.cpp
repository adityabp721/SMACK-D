...
/////////////////////////////////////////////////////////////
static std::string network_name = "lab9smackd";
static std::string network_passphrase = "lab9smackd";
...
int main() {
    ...
    while (true) {
        ...
        double val = sensor.read_u16();
         snprintf(out, 10, "%f \n", val);
        //if (val > 60000)
//        {
//            snprintf(out,10, "No fire \0");
//        }
//        else if(val > 40000 && val < 60000)
//        {
//            snprintf(out,15, "Fire at 20 to 30m \0");
//        }
//        else if(val > 20000 && val < 40000)
//        {
//            snprintf(out,15, "Fire at 10 to 20m \0");
//        }
//        else
//        {
//            snprintf(out,15, "Fire at 1 to 10m \0");
//        }
        for(int i=0;i<10;i++){
